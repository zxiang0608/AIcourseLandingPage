                ...
                <div className="p-6 md:p-12">
                    ...
                    {step === 3 && (
                        <div className="animate-in slide-in-from-top-4 duration-700">
                            <div className="flex flex-col md:flex-row items-center justify-between bg-green-500/10 border border-green-500/20 p-4 rounded-xl mb-8 gap-4">
                            ...
                            {/* Invoice Preview */}
                            <div className="bg-white text-black p-8 md:p-14 rounded-sm shadow-2xl max-w-3xl mx-auto overflow-hidden">
